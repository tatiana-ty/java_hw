...
public class ChatServer implements ServerSocketThreadListener, SocketThreadListener {
    ...
    public synchronized void onSocketStop(SocketThread thread) {
        ...
        if (client.isAuthorized() && !client.isReconnecting()) {
            ...
            logger.log(Level.INFO, String.format("%s disconnected", client.getNickname()));
        }
    ...
    private void handleNonAuthorizedMessage(ClientThread client, String msg) {
        ...
        if (nickname == null) {
            logger.log(Level.INFO, "Invalid login attempt: " + login);
            client.authFail();
            return;
        } else {
            ...
            if (oldClient == null) {
                ...
                logger.log(Level.INFO, nickname + " connected");
            } else {
                oldClient.reconnect();
